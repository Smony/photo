...
class PageSlidesController extends Controller
{
    public function __construct()
    {
        return view()->share([
            'activePage'    =>  'pageSlides'
        ]);
    }

    /**
     * Page-slides index page
     *
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function index()
    {
        $pageSlides = PageItem::where('category_id', PageItem::PAGE_SLIDES_CATEGORY)
                    ->orderBy('ordinal_position', 'ASC')
                    ->paginate();

        return view('admin.page-slides.index', [
